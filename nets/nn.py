...
class VGG16_BN(torch.nn.Module):
    def __init__(self, pretrained=True, freeze=True):
        ...
        vgg16_bn_url = 'http://download.pytorch.org/models/vgg16_bn-6c64b313.pth'
        vgg_pretrained_features = models.vgg16_bn(pretrained=False).features
        if pretrained:
            state_dict = load_state_dict_from_url(vgg16_bn_url, progress=True)
            vgg_pretrained_features.load_state_dict(state_dict)
